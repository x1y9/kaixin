...
import com.kaixin.core.sql2o.converters.Converter;
import com.kaixin.core.sql2o.converters.ConverterException;
import com.kaixin.core.sql2o.data.LazyTable;
import com.kaixin.core.sql2o.data.Row;
import com.kaixin.core.sql2o.data.Table;
import com.kaixin.core.sql2o.data.TableResultSetIterator;
import com.kaixin.core.sql2o.logging.LocalLoggerFactory;
import com.kaixin.core.sql2o.logging.Logger;
import com.kaixin.core.sql2o.quirks.Quirks;
import com.kaixin.core.sql2o.reflection.PojoIntrospector;
...
import static com.kaixin.core.sql2o.converters.Convert.throwIfNull;
...
public class Query implements AutoCloseable {
    ...
    private com.kaixin.core.sql2o.Connection connection;
    ...
    public Query(com.kaixin.core.sql2o.Connection connection, String queryText, boolean returnGeneratedKeys) {
        this(connection, queryText, returnGeneratedKeys, null);
    }

    public Query(com.kaixin.core.sql2o.Connection connection, String queryText, String[] columnNames) {
        this(connection, queryText, false, columnNames);
    }

    private Query(com.kaixin.core.sql2o.Connection connection, String queryText, boolean returnGeneratedKeys, String[] columnNames) {
    ...
    public com.kaixin.core.sql2o.Connection getConnection(){
    ...
    //改写以支持position parameter，原来的this.preparedStatement.setObject要在preparedStatement准备好之后才能用
    //不符合习惯，现在就和普通的addParameter一样用了。
    public Query setUnamedParameter(int i, Object obj) {
    ...
    //zhongshu: add
    public List<Map<String,Object>> executeAndFetchRows() {
        return executeAndFetchTable().asList();
    }

    public Map<String,Object> executeAndFetchFirstRow() {
        LazyTable lt =  executeAndFetchTableLazy();
        try {
            Iterator<Row> iterator = lt.rows().iterator();
            return iterator.hasNext() ? iterator.next().asMap() : null;
        }
        finally {
            lt.close();
        }
    ...
    public com.kaixin.core.sql2o.Connection executeUpdate(){
    ...
    public com.kaixin.core.sql2o.Connection executeBatch() throws Sql2oException {
        long start = System.currentTimeMillis();
        try {
            logExecution();
            PreparedStatement statement = buildPreparedStatement();
